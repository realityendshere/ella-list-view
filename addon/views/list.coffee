...
`import BaseViewMixin from 'ella-burn-ins/mixins/base-view'`
...
`import ListItemView from 'ella-list-view/views/list-item'`
...
ListView = Ember.CollectionView.extend BaseViewMixin, ScrollHandlerMixin, ResizeHandlerMixin,
